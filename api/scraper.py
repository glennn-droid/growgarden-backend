# api/scraper.py (Versi Final dengan Nama Kolom yang Benar)
import requests

def get_current_stock():
    """
    Mengambil data stok langsung dari API Supabase dengan nama kolom yang benar.
    """
    ...
    # Kita gunakan select=display_name sekarang
    urls = {
    ...
    for category, url in urls.items():
        try:
            ...
            for item_obj in items:
                # Kita ambil nilainya dari kolom 'display_name'
